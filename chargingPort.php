...
<head>
    <meta charset="utf-8">
    <title>AOR Fixman - Charging Port Problem</title>
...
<body>
    ...
    <!-- Charging Port Problem Section Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">Charging Port Problem</h1>
                <p>Having trouble with your charging port? Our expert technicians can quickly and effectively repair or replace faulty ports, so your device charges like new again.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-6">
                    <h4 class="mb-3">Charging Port Repair Services We Offer:</h4>
                    <ul class="service-list">
                        <li>Charging Port Replacement</li>
                        <li>Port Cleaning</li>
                        <li>Loose Connections Repair</li>
                        <li>Charging Speed Issue</li>
                        <li>And more...</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <img src="img/charging-port.png" class="img-fluid" alt="Charging Port Repair">
                </div>
            </div>
        </div>
    </div>
    <!-- Charging Port Problem Section End -->
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3">Charging Port Problem</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="service.html">Services</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Charging Port Problem</li>
                </ol>
            </nav>
        </div>
    </div>
