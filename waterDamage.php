...
<head>
    <meta charset="utf-8">
    <title>AOR Fixman - Water Damage Repair</title>
...
<body>
    ...
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Water Damage</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">Water Damage</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <!-- Water Damage Repair Section Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">Water Damage Repair</h1>
                <p>Did your device come into contact with water? Our experts provide comprehensive water damage repair services to restore your device’s functionality.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-6">
                    <h4 class="mb-3">Water Damage Repair Services We Offer:</h4>
                    <ul class="service-list">
                        <li>Water Extraction and Drying</li>
                        <li>Corrosion Treatment</li>
                        <li>Component Repair or Replacement</li>
                        <li>Battery, Screen, or Charging Port Damage Repair</li>
                        <li>And more...</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <img src="img/water-damaged-iphone.png" class="img-fluid" alt="Water Damage Repair">
                </div>
            </div>
        </div>
    </div>
    <!-- Water Damage Repair Section End -->
