...
<head>
    <meta charset="utf-8">
    <title>AOR Fixman - LCD Problem</title>
...
<body>
    ...
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">LCD Problem</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">LCD Problem</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <!-- LCD Problem Section Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">LCD Problem</h1>
                <p>Our expert technicians provide reliable and efficient LCD repair services to get your device back to perfect condition.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-6">
                    <h4 class="mb-3">LCD Repair Services We Offer:</h4>
                    <ul class="service-list">
                        <li>Screen Replacement</li>
                        <li>Touchscreen Issues</li>
                        <li>Color Distortion Repair</li>
                        <li>Backlight Issues</li>
                        <li>And more...</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <img src="img/phone-repair.jpg" class="img-fluid" alt="LCD Repair">
                </div>
            </div>
        </div>
    </div>
    <!-- LCD Problem Section End -->
