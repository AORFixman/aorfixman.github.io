...
<head>
    <meta charset="utf-8">
    <title>AOR Fixman - Submit Quote</title>
...
<body>
    ...
    <div class="container py-5">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Submit Quote</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">Quote</li>
                <li class="breadcrumb-item text-white active" aria-current="page">Submit Quote</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $special_note = $conn->real_escape_string($_POST['special_note']);

                    // SQL query to insert the data into the quotes table
                    $sql = "INSERT INTO quotes (name, mobile, email, service, special_note) VALUES ('$name', '$mobile', '$email', '$service', '$special_note')";
                    ...
                    if ($conn->query($sql) === TRUE) {
                        ...
                        echo '<a href="quote.html" class="btn btn-primary mt-3">Back to Quote</a>';
                    } else {
                        // Error occurred
